...
public class JSpot extends JPanel implements MouseListener, Spot {
	...
	public void mousePressed(MouseEvent e) {
		// Using mousePressed to trigger spotClicked because 
		// it feels more responsive and sometimes if you
		// move the mouse a little bit between pressing
		// the mouse down and releasing, the click doesn't
		// register.
